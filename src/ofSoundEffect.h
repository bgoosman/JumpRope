...
/** ofSoundEffectPassthrough
 ...
 An ofSoundEffect that simply passes audio through, allowing access to the ofDspChainSoundBuffer of audio 
 passing through it. 
...
public:
	...
	ofDspChainSoundBuffer& getBuffer() { return inputBuffer; }
};
