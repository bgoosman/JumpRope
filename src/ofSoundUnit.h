...
public:
	...
	ofDspChainSoundBuffer();
	ofDspChainSoundBuffer( const ofDspChainSoundBuffer& other );
	ofDspChainSoundBuffer( int nFrames, int nChannels );
	ofDspChainSoundBuffer& operator=( const ofDspChainSoundBuffer& other );
	
	~ofDspChainSoundBuffer();
	void copyFrom( const ofDspChainSoundBuffer& other );	
	/// Set audio data to 0.
	void clear();
...
protected:
	...
	ofSoundSource* input;
	ofDspChainSoundBuffer inputBuffer;
